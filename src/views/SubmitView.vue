<template>
    ...
    <div style="margin-top: 6%;  margin-left: 6.5%;">
      <section class="inicio-content" style="width: 100%; padding: 10px; background-color: #000000; height: 87.5vh; ">
        <h2 style="color: white; margin-left: 2%; padding: 1rem;">Subir dibujo</h2>
